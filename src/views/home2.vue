<template>
  <div class="home">
    ...
    <div class="container">
      ...
      <div>
        <Button shape="circle" size="large" style="width:102px;">App标准化</Button>
        <Button type="primary" style="margin-left:20px; width:102px;" shape="circle" size="large">机型标准化</Button>
      </div>
       <div style="margin-top:20px; margin-bottom:20px;">
         <Button type="primary" shape="circle" size="large" style="width:102px;">地理信息</Button>
          <Button style="margin-left:20px; width:102px;" shape="circle" size="large">积木</Button>
      </div>
      <div>
        <Button  shape="circle" size="large" style="width:102px;">监控</Button>
      </div>
    </div> 
	  <div class="laboratory">
	     <img src="../assets/grid_017277d.png" alt="" class="con grid">
	     <div class="con machine">
			<img src="../assets/machine_b35833f.png" alt="">
			<div class="con box-machine">
				<div class="con layer"></div>
				<div class="con layer"></div>
			</div>
			<div class="con chart-machine">
			    <div class="con lines">
	     ...
	     <div class="con card">
			<svg width="490px" height="239px" viewBox="0 0 490 239" xmlns="http://www.w3.org/2000/svg">
              <defs>
                ...
                <radialGradient cx="48.0512" cy="206.829" r="50" gradientUnits="userSpaceOnUse" id="linearGradientCordStreamPhone">
                ...
                <radialGradient cx="231" cy="92" r="60" gradientUnits="userSpaceOnUse" id="linearGradientCordStreamMac">
                ...
                <radialGradient cx="49.7332" cy="10.2511" r="30" gradientUnits="userSpaceOnUse" id="linearGradientCordStreamLaptop">
                ...
                <linearGradient x1="100%" y1="50%" x2="46.1667201%" y2="50%" id="linearGradientDevier">
                  <stop stop-color="#78b9f1" offset="0%"></stop>
                  <stop stop-color="#78aaf1" offset="100%"></stop>
                </linearGradient>
                <radialGradient cx="53.3394396%" cy="50%" fx="53.3394396%" fy="50%" r="55.3288719%" gradientTransform="translate(0.533394,0.500000),scale(0.458522,1.000000),rotate(90.000000),scale(1.000000,2.472451),translate(-0.533394,-0.500000)" id="radialGradientDriver">
                  <stop stop-color="#78b9f1" offset="0%"></stop>
                  <stop stop-color="#78b9f1" offset="39.7421078%"></stop>
                  <stop stop-color="#78aaf1" offset="100%"></stop>
                </radialGradient>
              </defs>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="lines">
                  <g stroke="red" opacity="0" stroke-width="4">
                  ...
                  <g stroke-linecap="round" stroke-linejoin="round">
                    <!-- <use class="line_laptop" stroke="#78aaf1" stroke-width="2" xlink:href="#pathLaptop"></use>
                    <use class="line_phone" stroke="#78aaf1" stroke-width="2" xlink:href="#pathPhone"></use>
                    <use class="line_mac1" stroke="#78aaf1" stroke-width="2" xlink:href="#pathMac1"></use> -->
                  ...
                  <g transform="translate(207.000000, 37.000000)">
                    <g transform="translate(0.000000, 39.326707)">
                      <path d="M29,43.2199993 C45.0162577,43.2199993 58,37.2673211 58,29.9243204 C58,27.5375223 58,22.8960822 58,16 L0,16 C0,20.3875465 0,25.0289866 0,29.9243204 C0,37.2673211 12.9837423,43.2199993 29,43.2199993 Z" fill="#78cdf1" style="mix-blend-mode: multiply;" opacity="0.4"></path>
                      <path d="M29,40.2229694 C45.0162577,40.2229694 58,34.2696417 58,26.9258398 C58,24.5387812 58,19.8968347 58,13 L0,13 C0,17.3880252 0,22.0299718 0,26.9258398 C0,34.2696417 12.9837423,40.2229694 29,40.2229694 Z" fill="#78aaf1"></path>
                      <ellipse fill="#78cdf1" cx="29" cy="13.2971296" rx="29" ry="13.2971296"></ellipse>
                    </g>
                    <g transform="translate(0.000000, 19.562662)">
                      <path d="M29,40.7294728 C45.0162577,40.7294728 58,34.7761451 58,27.4323431 C58,25.0452846 58,20.403338 58,13.5065034 L0,13.5065034 C0,17.8945286 0,22.5364752 0,27.4323431 C0,34.7761451 12.9837423,40.7294728 29,40.7294728 Z" fill="#78aaf1"></path>
                      <ellipse fill="#78cdf1" cx="29" cy="13.2971296" rx="29" ry="13.2971296"></ellipse>
                    </g>
                    <g>
                      <path d="M29,40.7294728 C45.0162577,40.7294728 58,34.7761451 58,27.4323431 C58,25.0452846 58,20.403338 58,13.5065034 L0,13.5065034 C0,17.8945286 0,22.5364752 0,27.4323431 C0,34.7761451 12.9837423,40.7294728 29,40.7294728 Z" fill="#78aaf1"></path>
                      <ellipse fill="#78aaf1" cx="29" cy="13.2971296" rx="29" ry="13.2971296"></ellipse>
                    </g>
                    <g fill="#787bf1" opacity="0.6">
                  ...
                  <g stroke="#78aaf1" opacity="0.15" stroke-width="4">
	     ...
	     <div class="con laptop">
	     	<img src="../assets/laptop_fd4699c.png" alt="">
	     	<div class="con layerBox">
				<div class="con layer">
				<div class="con page">
					<svg class="con picture" width="32px" height="43px" viewBox="0 0 53 71" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                  ...
                  <em class="con text"></em>
                  <em class="con text"></em>
                  <em class="con text"></em>
                  <em class="con text"></em>
                  <em class="con text"></em>
				</div>
				<div class="con userBox">
				   <em class="con user1"></em>
				   <em class="con user2"></em>
				   <svg class="component user3" width="60px" height="120px" viewBox="0 0 60 120" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                    ...
                    <g transform="translate(6, 26) scale(0.8)" stroke="none" stroke-width="10" fill="#fff" fill-rule="evenodd">
	     ...
	     <div class="con phone">
			<img src="../assets/phone_66669bd.png" alt="">
			<div class="box-phone con">
				<div class="con layer"></div>
				<div class="con layer"></div>
			</div>
			<div class="box-phone con">
			...
			<div class="box-phone con"></div>
	     </div>
	     <div class="con mac">
			<img src="../assets/mac_3336890.png" alt="">
			<div class="con box-mac">
					<div class="con layer">
                <svg class="con folder" width="65px" height="66px" viewBox="0 0 65 66" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                  ...
                  <g stroke="none" stroke-width="1" fill="#AEAEAE" fill-rule="evenodd" opacity="0.3">
                ...
                <svg class="con folder" width="65px" height="66px" viewBox="0 0 65 66" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <lineargradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradientFolder1">
                      <stop stop-color="#78aaf1" offset="0%"></stop>
                      <stop stop-color="#78aaf1" stop-opacity="0.2" offset="100%"></stop>
                    </lineargradient>
                  </defs>
                  <g stroke="none" stroke-width="1" fill="#78aaf1" fill-rule="evenodd" opacity="0.5">
                    <polygon points="4 4 29 4 32 16 65 16 65 62 4 62"></polygon>
                  </g>
                </svg>
                <svg class="con folder" width="65px" height="66px" viewBox="0 0 65 66" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <lineargradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradientFolder2">
                      <stop stop-color="#78aaf1" offset="0%"></stop>
                      <stop stop-color="#78aaf1" stop-opacity="0.45" offset="100%"></stop>
                    </lineargradient>
                  </defs>
                  <g stroke="none" stroke-width="1" fill="#78aaf1" fill-rule="evenodd">
                    <polygon points="4 4 29 4 32 16 65 16 65 62 4 62"></polygon>
                  </g>
                </svg>
                <svg class="con chart-pie" width="46px" height="46px" viewBox="0 0 46 46" xmlns="http://www.w3.org/2000/svg">
                  <g transform="scale(0.8) translate(6, 6)">
                    <circle cx="23" cy="23" r="22" fill="#78aaf1" stroke="none" fill-rule="evenodd"></circle>
                    <path transform="translate(23, 23)" fill="#7889f1" d="M 0 0 v -22 A 22 22 1 0 1 22 -7.654042494670958e-15 z"></path>
                  </g>
                </svg>
                <div class="con chart-progress">
                  <em class="con progress-circle"></em>
                  <em class="con progress-circle"></em>
                  <em class="con progress-circle"></em>
                  <div class="con progress-bar-box">
                    <em class="con progress-bar"></em>
                    <em class="con progress-bar"></em>
                    <em class="con progress-bar"></em>
                    <em class="con progress-bar"></em>
                    <em class="con progress-bar"></em>
